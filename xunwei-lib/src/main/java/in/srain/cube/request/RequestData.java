...
public class RequestData {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                if(value instanceof JsonAble){
                	...
                	sb.append(jvalue.toJsonString());
                	break;
                	
                }
                
                sb.append(URLEncoder.encode(key, CHAR_SET));
                sb.append(CHAR_EQ);
                if (value != null) {
                    sb.append(URLEncoder.encode(value.toString(), CHAR_SET));
                }
	...
	public void setCacheKey(String mCacheKey) {
